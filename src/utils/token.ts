...
/**
 * Только пути этого приложения: локальные "/x" (не "//x" — это чужой origin)
 * или абсолютные URL того же origin. Защита от open redirect, когда returnTo
 * приходит из параметров Bulka-флоу или сохранённого состояния.
 */
