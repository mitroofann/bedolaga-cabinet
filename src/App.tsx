...
const AdminMarketingBots = lazyWithRetry(() => import('./pages/AdminMarketingBots'));
  ...
  return (
    <>
      ...
      <Routes>
        ...
        />
        <Route
          path="/admin/marketing-bots"
          element={
            <PermissionRoute permission="marketing_bots:read">
              <LazyPage>
                <AdminMarketingBots />
              </LazyPage>
            </PermissionRoute>
