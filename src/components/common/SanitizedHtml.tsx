  ...
  return (
    <Tag
      className={cn(
        ...
        // spacing only — no list markers (authors use emoji as markers) and no
        // alignment/display overrides.
        'break-words [&_a]:underline [&_li]:mt-1 [&_ol]:mt-1.5 [&_ol]:list-decimal [&_ol]:pl-5 [&_p]:mt-1.5 [&_ul]:mt-1.5',
        className,
      )}
